		...
		<div class="collapse navbar-collapse  w-auto  max-height-vh-100"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a
                    ...
                    href="${pageContext.request.contextPath}/admin/brand">
                        <div
                            class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">dashboard</i>
                ...
                <li class="nav-item"><a
                    ...
                    href="${pageContext.request.contextPath}/admin/category">
                        <div
                            class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">dashboard</i>
                        </div> <span class="nav-link-text ms-1">Quản lý Loại giày</span>
                </a></li>
				<li class="nav-item"><a
				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Quản lý đơn hàng</li>
					</ol>
									...
									<thead>
										<tr>
											<th
												...
												đơn hàng</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ngày
												đặt hàng</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên
												người nhận</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Địa
												chỉ</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Số
												điện thoại</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ghi
												chú khách hàng</th>
											<th
										...
										<c:forEach var="item" items="${listDonHang}">
											<tr>
												<td class="align-middle text-center text-sm">
													<p class="text-xs font-weight-bold mb-0">${item.maDonHang}</p>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.ngayDatHang}</span>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.tenNguoiNhan}</span>
												</td>
												<td class="align-middle text-center"><span
												...
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.ghiChuKhachHang}</span>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.tongTien}</span>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.ngayGiaoDuKien}</span>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.trangThai}</span>
												</td>
												<td class="align-middle text-center"><a
													href="/admin/order/update?maDonHang=${item.maDonHang}"
													class="text-secondary font-weight-bold text-xs"> Chi
														tiết </a> <a
													href="/admin/order/delete?maDonHang=${item.maDonHang}"
													onclick="return confirm('Bạn có muốn xóa đơn hàng ${item.maDonHang} không?');"
