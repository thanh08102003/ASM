				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Quản lý Loại giày</li>
					</ol>
					<h6 class="font-weight-bolder mb-0">Quản lý Loại giày</h6>
				</nav>
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<form action="/admin/category" method="get"
						...
						<div class="input-group input-group-outline">
							<label class="form-label">Nhập tên loại giày...</label> <input
		...
		<div class="container-fluid py-4">
			...
			<form method="post" style="width: 600px; margin: auto;"
				...
				<div class="form-group">
					<input name="maLoaiGiay" value="${loaiGiayItem.maLoaiGiay}" type="hidden"
						class="form-control" readonly
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Tên loại giày</label> <input name="tenLoaiGiay"
						value="${loaiGiayItem.tenLoai}" type="text" class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px; margin-bottom: 10px;">
				</div>
				<button formaction="/admin/category/update" class="btn btn-info"
					type="submit">Sửa</button>
				<a class="btn btn-danger"
					href="/admin/brand/delete?maLoaiGiay=${loaiGiayItem.maLoaiGiay}"
					onclick="return confirm('Bạn có muốn xóa ${loaiGiayItem.tenLoai} không? Thao tác này sẽ xóa tất cả các giày thuộc loại giày này, đồng thời sẽ xóa tất cả những chi tiết hóa đơn có danh sách giày thuộc hãng ${item.tenLoai}');"
