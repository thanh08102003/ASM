				...
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<form action="/admin/category" method="get"
						...
						<div class="input-group input-group-outline">
							<label class="form-label">Nhập tên loại giày cần tìm</label> <input
		...
		<div class="container-fluid py-4">
			...
			<div class="row">
				...
				<div class="position-relative mt-n4 mx-3 " style="color: red">
					${inserted}</div>
				<div class="col-12">
					<form class="card my-4" action="/admin/category/insert" method="get">
						<div class="position-relative mt-n4 mx-3 ">
							<button class="btn btn-success" style="float: right;">Thêm Loại giày mới</button>
						</div>
					</form>
					<div class="card my-4">
						<div
									...
									<thead>
										<tr>
											<th
												...
												loại giày</th>
											<th
												class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên loại giày</th>
										...
										<c:forEach var="item" items="${listLoaiGiay}">
											<tr>
												<td class="align-middle text-center text-sm">
													<p class="text-xs font-weight-bold mb-0">${item.maLoaiGiay}</p>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.tenLoai}</span>
												</td>
												<td class="align-middle text-center"><a
													href="/admin/category/update?maLoaiGiay=${item.maLoaiGiay}"
													class="text-secondary font-weight-bold text-xs"> Chi
														tiết </a> <a href="/admin/category/delete?maLoaiGiay=${item.maLoaiGiay}"
													onclick="return confirm('Bạn có muốn xóa loại giày ${item.tenLoai} không? Thao tác này sẽ xóa tất cả các giày thuộc loại giày này, đồng thời sẽ xóa tất cả những chi tiết hóa đơn có danh sách giày thuộc hãng ${item.tenLoai}');"
