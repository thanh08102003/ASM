				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-dark active"
							aria-current="page">Quản lý Hãng giày</li>
					</ol>
					<h6 class="font-weight-bolder mb-0">Quản lý Hãng giày</h6>
				</nav>
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<form action="/admin/brand" method="get"
						...
						<div class="input-group input-group-outline">
							<label class="form-label">Nhập tên hãng giày...</label> <input
		...
		<div class="container-fluid py-4">
			...
			<form method="post" style="width: 600px; margin: auto;"
				...
				<div class="form-group">
					<input name="maHangGiay" value="${hangGiayItem.maHang}" type="hidden"
						class="form-control" readonly
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Tên hãng giày</label> <input name="tenHangGiay"
						value="${hangGiayItem.tenHang}" type="text" class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px; margin-bottom: 10px;">
				</div>
				<button formaction="/admin/brand/update" class="btn btn-info"
					type="submit">Sửa</button>
				<a class="btn btn-danger"
					href="/admin/brand/delete?maHangGiay=${hangGiayItem.maHang}"
