...
<html>
<head>
<title>Shoes Shop Categories</title>
<meta charset="utf-8">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li class="active"><a href="#"><i
										class="fa fa-angle-double-right" aria-hidden="true"></i> Nam</a></li>
								<li><a href="#"> Nữ</a></li>
											...
											<li><span class="type_sorting_text">Tất cả</span> <i
												...
												<ul class="sorting_type">
													<a href="#"><li class="type_sorting_btn"><span>Tất
																cả</span></li></a>
													<a href="#"><li class="type_sorting_btn"><span>Adidas</span></li></a>
													<a href="#"><li class="type_sorting_btn"><span>Nike</span></li></a>
													<a href="#"><li class="type_sorting_btn"><span>Vans</span></li></a>
													<a href="#"><li class="type_sorting_btn"><span>Converse</span></li></a>
												</ul></li>
												...
												<a href="/detail?idProduct=${item.maGiay}">
													<div class="product-item col-4">
														...
														<button data-masanpham="${item.maGiay}"
															class="red_button add_to_cart_button btnAddToCart btn-danger">ADD
															TO CART</button>
													</div>
												</a>
											</c:forEach>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="footer_nav_container">
								<div class="cr">
									©2022 All Rights Reserverd. Made with <i class="fa fa-heart-o"
										aria-hidden="true"></i> by <a href="#">Minh Triet</a>
								</div>
							</div>
						</div>
					</div>
